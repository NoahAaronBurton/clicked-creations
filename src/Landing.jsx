...
import backgroundImage from './assets/grid-mist.png';
...
export default function Landing() {   
    ...
    return (
        <div className="flex flex-col w-full overflow-y-auto text-white bg-fixed bg-overlay" style={{backgroundImage: `url(${backgroundImage})`}}>
            <div className="flex flex-col w-full overflow-y-auto " >
                ...
                <div className="flex justify-center ">
                    <div className="flex-1  w-3/4">
                        ...
                        <p className="text-lg text-pretty text-center px-4 mt-4 mb-4">
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <button className="p-4 max-w-xs  rounded-lg bg-gradient-to-l from-orange-500 to-red-500 " onClick={goHome}>Try it out</button>
                    </div>
            </div>
            
                <div className="flex flex-col items-center justify-center w-full h-full mt-6 bg-darker rounded-md drop-shadow-2xl">
                    <h2 className="text-4xl text-center py-4 drop-shadow-xl">Our Services</h2>
